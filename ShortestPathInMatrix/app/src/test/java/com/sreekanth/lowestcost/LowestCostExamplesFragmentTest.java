...
@Config(constants = BuildConfig.class, sdk = 21, manifest = "src/main/AndroidManifest.xml", packageName = "com.sreekanth.lowestcost")
public class LowestCostExamplesFragmentTest {

    private LowestCostExamplesFragment fragment;

    @Before
    public void setUp() {
        fragment = new LowestCostExamplesFragment();
    ...
    public void clickingExampleOneButtonLoadsExampleGridOne() {
        String expectedContents = MatrixUtils.EXAMPLE_MATRIX_1.asDelimitedString("\t");
    ...
    public void clickingExampleTwoButtonLoadsExampleGridTwo() {
        String expectedContents = MatrixUtils.EXAMPLE_MATRIX_2.asDelimitedString("\t");
    ...
    public void clickingExampleThreeButtonLoadsExampleGridThree() {
        String expectedContents = MatrixUtils.EXAMPLE_MATRIX_3.asDelimitedString("\t");

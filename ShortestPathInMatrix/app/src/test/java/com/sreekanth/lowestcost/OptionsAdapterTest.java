...
public class OptionsAdapterTest {
    ...
    public void setUp() {
        ...
        pagerAdapter = new OptionsAdapter(fragmentManager);
    }
    ...
    public void firstItemOfTheAdapterIsTheExamplesFragment() {
        assertThat(pagerAdapter.getItem(0), instanceOf(LowestCostExamplesFragment.class));
    }

    @Test
    public void secondItemOfTheAdapterIsTheCustomFragment() {
        assertThat(pagerAdapter.getItem(1), instanceOf(LowestCostCustomFragment.class));
    }
    ...
    public void pageTitleOfTheSecondItemIsExampleGrids() {
        assertThat(pagerAdapter.getPageTitle(1).toString(), equalTo("Custom Matrix"));
    }

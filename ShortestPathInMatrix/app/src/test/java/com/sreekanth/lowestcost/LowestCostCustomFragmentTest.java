...
public class LowestCostCustomFragmentTest {

    private LowestCostCustomFragment fragment;

    @Before
    public void setUp() {
        fragment = new LowestCostCustomFragment();
    ...
    public void clickingGoWithLessThanFiveColumnsOfDataDisplaysErrorMessage() {
        ...
        assertThat(alertDialog.getTitle().toString(), equalTo("Invalid Matrix"));

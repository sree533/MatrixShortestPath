...
public class LowestCostCustomFragment extends Fragment {

    public LowestCostCustomFragment() {}
    ...
    private void loadGrid(int[][] contents) {
        Matrix validMatrix = new Matrix(contents);
        MatrixLookup visitor = new MatrixLookup(validMatrix);
        ...
        ((TextView) getView().findViewById(R.id.grid_contents)).setText(validMatrix.asDelimitedString("\t"));
    }
    ...
    class GoOnClickListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            int[][] potentialGridContents = MatrixUtils.gridArrayFromString(gridString);
